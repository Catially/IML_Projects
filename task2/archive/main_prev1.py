...
def features_engineering(df_ori):
    ...
    feature = df_ori.groupby(['pid'], sort=False).agg([np.max, np.min, np.mean, np.median, np.std, np.ptp])
...
# parameters found by gridsearch
# learning rate, max_depth, subsample
param = np.zeros(shape = (15,3))
param[0] = [0.1, 5, 0.9] # LABEL_BaseExcess
param[1] = [0.1, 3, 0.75] # LABEL_Fibrinogen
param[2] = [0.15, 3, 0.9] # LABEL_AST, ### not that good
param[3] = [0.15, 3, 1.0] # LABEL_Alkalinephos, ### not that good
param[4] = [0.1, 3, 0.7] # LABEL_Bilirubin_total, ### not that good
param[5] = [0.1, 3, 0.75] # LABEL_Lactate
param[6] = [0.1, 3, 0.5] # LABEL_TroponinI
param[7] = [0.05, 5, 0.75] # LABEL_SaO2
param[8] = [0.05, 3, 0.75] # LABEL_Bilirubin_direct
param[9] = [0.05, 5, 0.75] # LABEL_EtCO2
param[10] = [0.05, 3, 1.0] # LABEL_Sepsis, ### not that good 
param[11] = [0.1, 3, 0.9] # LABEL_RRate, ### not that good
...
#     #     'subsample':[0.50, 0.6, 0.7, 0.8, 0.9, 1.0]
#     # }
